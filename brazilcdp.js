...
module.exports = {
        config: {
                ...
                role: 0,
                description: {
                        bn: "ব্রাজিল কাপল প্রোফাইল পিকচার (CDP) পান",
                        en: "Get random Brazil couple profile pictures (CDP)"
                },
                category: "media",
                guide: {
                        bn: '   {pn}: রেন্ডম ব্রাজিল কাপল ডিপি পেতে ব্যবহার করুন',
                        en: '   {pn}: Use to get random Brazil couple DP'
                }
        },
        ...
        langs: {
                bn: {
                        ...
                        success: "🇧🇷 𝐇𝐞𝐫𝐞'𝐬 𝐲𝐨𝐮𝐫 𝐫𝐚𝐧𝐝𝐨𝐦 𝐁𝐫𝐚𝐳𝐢𝐥 𝐜𝐝𝐩 𝐛𝐚𝐛𝐲.",
